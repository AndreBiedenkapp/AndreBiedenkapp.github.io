...
<div class="figcaption">
    <p>
        ...
        *Avg. Train Reward* shows the average training reward over the last $\color{gray}100$ episodes. The agents use a fixed $\color{gray}\epsilon$ of $\color{gray}0.1$.
        The maximal $\color{gray}\mathcal{Q}$-values are overlayed in green. The brighter the shade, the higher the value. <strong>When selecting a different environment you need to press "(RE-)START"</strong>
    </p>
    <br>
</div>
